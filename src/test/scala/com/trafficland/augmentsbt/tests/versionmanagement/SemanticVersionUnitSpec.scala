...
import com.trafficland.augmentsbt.versionmanagement.{InvalidSnapshotVersionFormatException, SemanticVersion}
...
class SemanticVersionUnitSpec extends WordSpec with Matchers {
  ...
  "toFinal" should {
    ...
    "throw InvalidSnapshotVersionFormatException for release versions." in {
      an [InvalidSnapshotVersionFormatException] should be thrownBy { SemanticVersion.stripSnapshot(finalVersion) }
    }
  }
